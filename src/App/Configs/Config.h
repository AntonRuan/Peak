...
#define CONFIG_SCREEN_BUFFER_SIZE   (CONFIG_SCREEN_HOR_RES * 10)//(CONFIG_SCREEN_HOR_RES * CONFIG_SCREEN_VER_RES /2)
...
/* IMU */
#define CONFIG_IMU_INT1_PIN         -1
#define CONFIG_IMU_INT2_PIN         -1
...
#define CONFIG_SD_MISO_PIN          -1
#define CONFIG_SD_SCK_PIN           -1
