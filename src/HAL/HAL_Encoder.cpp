...
{
    if (en) {
        Serial.println("Encoder_SetEnable ture");
    } else {
        Serial.println("Encoder_SetEnable false");
    }
    EncoderEnable = en;
}
